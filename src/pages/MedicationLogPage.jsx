            ...
            <div className="log-card">
                ...
                <div className="symptom-section">
                    ...
                    <div className="taken-toggle">
                        <button
                            className={`taken-btn ${form.taken ? "yes" : ""}`}
                            onClick={() => setForm({ ...form, taken: true })}
                        >
                            ✅ Yes, I took it
                        </button>
                        <button
                            className={`taken-btn ${!form.taken ? "no" : ""}`}
                            onClick={() => setForm({ ...form, taken: false })}
                        >
                            ❌ Missed dose
                        </button>
                    </div>
                ...
                <div className="symptom-section">
                    <div className="form-group-log">
                        ...
                        <textarea
                            name="sideEffectNotes"
                            value={form.sideEffectNotes}
                            onChange={handleChange}
                            placeholder="Any side effects or reactions to note..."
                            rows={2}
                        />
                    </div>
                </div>
